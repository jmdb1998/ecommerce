<header class="bg-trueGray-700 sticky top-0" x-data="dropdown()">
    <div class="container-menu flex items-center h-16 justify-between md:justify-start">
        <a :class="{'bg-opacity-100 text-orange-500': open}"
           x-on:click="show()"
           class="flex flex-col items-center justify-center order-last md:order-first px6 sm:px-4 bg-white bg-opacity-25 text-white cursor-pointer font-semibold hfull">
            <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                <path class="inline-flex" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M412h16M4 18h16" />
            </svg>
            <span class="text-sm hidden sm:block">Categorías</span>
        </a>
        <a href="/" class="mx-6">
    ...
    <nav id="navigation-menu" x-show="open" :class="{'block': open, 'hidden': !open}" class="bg-trueGray-700 bg-opacity-25 w-full absolute hidden">
        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            @auth
                ...
                text-trueGray-500 hover:bg-orange-500 hover:text-white">
                    <span class="flex justify-center w-9">
